										...
										<div class="row">
											...
											<div class="col-md-6">
												<table>
                                                    ...
                                                    <tr><td>Mobile Number</td><td><b><?php echo $row["mobile"]; ?></b></td></tr>
													<tr><td>Password</td><td><b><?php echo $row["password"]; ?></b></td></tr>
                                                    <tr><td>Address</td><td><b><?php echo $row["address1"]; ?></b></td></tr>
                                                    <tr><td>Country</td><td><b><?php echo $row["address2"]; ?></b></td></tr>
												</table>
											</div>
                                            <?php echo'
                                                <div class="col-md-2">
                                                    <div class="btn-group">
                                                        <a href="#" remove_id="'.$id.'" class="btn btn-danger remove_user"><span class="glyphicon glyphicon-trash"></span></a>
